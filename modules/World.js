...
export class World {
  ...
  _Initialize() {
    ...
    const envTexture = loader.load([
      './resources/textures/env/right.jpeg',
      './resources/textures/env/left.jpeg',
      './resources/textures/env/top.jpeg',
      './resources/textures/env/bottom.jpeg',
      './resources/textures/env/front.jpeg',
